...
public class Serializer {
	...
	static {
		...
		new ClassHandler<>(ItemStack.class, (e) -> ShapedRecipe.itemFromJson(e.getAsJsonObject()), PacketBuffer::readItem, (p, is) -> p.writeItemStack(is, false));
		...
		new RLClassHandler<>(Potion.class, () -> ForgeRegistries.POTION_TYPES);
	...
	@SuppressWarnings({"unchecked", "rawtypes"})
	public static Object fromRaw(PacketBuffer buf, TypeInfo cls, Object ans) throws Exception {
	...
	public static void toRaw(PacketBuffer buf, TypeInfo cls, Object obj) throws Exception {
		if (obj == null) {
			buf.writeByte(0);
			return;
