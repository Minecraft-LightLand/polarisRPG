package org.xkmc.polaris_rpg.content.weapons;
...
public class BaseShovelItem extends ShovelItem implements IBaseTieredItem {

	private final ToolProficiency proficiency;
	private final BaseItemTier tier;

	public BaseShovelItem(BaseItemTier tier, ToolProficiency proficiency, Properties properties) {
