...
public class BaseAxeItem extends AxeItem implements IBaseTieredItem {

	private final ToolProficiency proficiency;
	private final BaseItemTier tier;

	public BaseAxeItem(BaseItemTier tier, ToolProficiency proficiency, Properties properties) {
